...
draw2d.shape.flowchart.StartEventCircle = draw2d.VectorFigure.extend({
 
 NAME: 'draw2d.shape.flowchart.StartEventCircle',
...
draw2d.shape.flowchart.StartEventCirclePorts = draw2d.shape.flowchart.StartEventCircle.extend({

 NAME: 'draw2d.shape.flowchart.StartEventCirclePorts',
...
// FlowChart - StartEvent - Label erstellen
draw2d.shape.flowchart.StartEvent = draw2d.shape.flowchart.StartEventCirclePorts.extend({

 NAME: 'draw2d.shape.flowchart.StartEvent',

	init: function(attr, setter, getter) {
  this._super(attr, setter, getter);
  this.classLabel = new draw2d.shape.basic.Label({
   stroke: 1,
   text: LangVar['txt_Start'],
   fontSize: 16,
   color: "#",
   fontColor: "#303030",
   bgColor: "#",
