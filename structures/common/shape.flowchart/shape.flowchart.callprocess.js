...
// Wir erstellen das CallProcess-Rechteck
draw2d.shape.flowchart.CallProcessRectangle = draw2d.VectorFigure.extend({
 
 NAME: 'draw2d.shape.flowchart.CallProcessRectangle',
...
draw2d.shape.flowchart.CallProcessRectanglePorts = draw2d.shape.flowchart.CallProcessRectangle.extend({

 NAME: 'draw2d.shape.flowchart.CallProcessRectanglePorts',
...
draw2d.shape.flowchart.CallProcess = draw2d.shape.flowchart.CallProcessRectanglePorts.extend({

 NAME: 'draw2d.shape.flowchart.CallProcess',

	init: function(attr, setter, getter) {
  this._super(attr, setter, getter);
  this.classLabel = new draw2d.shape.basic.Label({
   stroke: 1,
   text: LangVar['txt_CallProcess'],
   fontSize: 16,
   color: "#",
   fontColor: "#303030",
   bgColor: "#",
  ...
  var imgSymbol = new draw2d.shape.icon.Ff({width: 16, height: 16, color: "#707070"});
