...
draw2d.shape.flowchart.SubProcessRectangle = draw2d.VectorFigure.extend({
 
 NAME: 'draw2d.shape.flowchart.SubProcessRectangle',
 ...
 repaint: function(attributes) {
  ...
  // Innere Box
  path.push('M', box.x + 10, ' ', box.y);
  path.push('L', box.x + box.w - 10, ' ', box.y);
  path.push('L', box.x + box.w - 10, ' ', box.y + box.h);
  path.push('L', box.x + 10, ' ', box.y + box.h, 'Z');
...
draw2d.shape.flowchart.SubProcessPorts = draw2d.shape.flowchart.SubProcessRectangle.extend({

 NAME: 'draw2d.shape.flowchart.SubProcessPorts',
...
// FlowChart - Subprocess erstellen
draw2d.shape.flowchart.Subprocess = draw2d.shape.flowchart.SubProcessPorts.extend({

 NAME: 'draw2d.shape.flowchart.Subprocess',

	init: function(attr, setter, getter) {
  this._super(attr, setter, getter);
  this.classLabel = new draw2d.shape.basic.Label({
   stroke: 1,
   text: LangVar['txt_SubProcess'],
   fontSize: 16,
   color: "#",
   fontColor: "#303030",
   bgColor: "#",
